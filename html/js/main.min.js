...
const calculateScrollbarWidth=function(){const e=document.createElement("div");e.style.visibility="hidden",e.style.overflow="scroll",document.body.appendChild(e);var t=document.createElement("div"),t=(e.appendChild(t),e.offsetWidth-t.offsetWidth);return document.body.removeChild(e),t},setDocumentViewportWith=()=>{function e(){var e=document.documentElement.clientWidth;document.documentElement.style.setProperty("--vw",e+"px")}e(),window.addEventListener("resize",e)},toggleMenu=()=>{let t=document.querySelector(".header__menu"),i=document.querySelector(".header__burger"),o=document.querySelector(".header");i.addEventListener("click",e=>{i.classList.toggle("is-active"),i.classList.contains("is-active")?(document.body.style.overflow="hidden",document.body.style.paddingRight=calculateScrollbarWidth()+"px",o.style.paddingRight=calculateScrollbarWidth()+"px",t.classList.add("is-active")):(document.body.style.overflow="",t.classList.remove("is-active"),document.body.style.paddingRight="",o.style.paddingRight="")},!1),window.onkeydown=function(e){27===e.keyCode&&(document.body.style.overflow="",t.classList.remove("is-active"),document.body.style.paddingRight="",o.style.paddingRight="",i.classList.remove("is-active"))}},headerFixed=()=>{let e=document.querySelector(".header"),t=()=>{0<window.scrollY?e.classList.add("is-fixed"):e.classList.remove("is-fixed")};t(),window.addEventListener("scroll",()=>{t()},!1)},heroSlider=()=>{let e=document.querySelector("#indexHero");e&&imagesLoaded(e,()=>{new Swiper(e,{speed:1e3,slidesPerView:"auto",loop:!0,autoHeight:!0,navigation:{nextEl:"#indexHeroControls .swiper-button-next",prevEl:"#indexHeroControls .swiper-button-prev"},pagination:{el:"#indexHeroControls .swiper-pagination",type:"bullets",clickable:!0},autoplay:{delay:4e3,disableOnInteraction:!1}})})},aboutOptionsSlider=()=>{let t=document.querySelector("#aboutOptions"),i;if(t){let e=()=>{window.innerWidth<768&&(i=new Swiper(t,{speed:1e3,slidesPerView:"auto",spaceBetween:20,loop:!0,pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},autoplay:{delay:4e3,disableOnInteraction:!1},breakpoints:{479:{spaceBetween:34}}}))};e(),window.addEventListener("resize",()=>{window.innerWidth<768&&!t.classList.contains("swiper-initialized")&&e(),768<=window.innerWidth&&t.classList.contains("swiper-initialized")&&i.destroy()})}},aboutComfortSlider=()=>{let t=document.querySelector("#aboutComfort"),i;if(t){let e=()=>{window.innerWidth<480&&(i=new Swiper(t,{speed:1e3,slidesPerView:"auto",spaceBetween:20,loop:!0,pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},autoplay:{delay:4e3,disableOnInteraction:!1}}))};e(),window.addEventListener("resize",()=>{window.innerWidth<480&&!t.classList.contains("swiper-initialized")&&e(),480<=window.innerWidth&&t.classList.contains("swiper-initialized")&&(i.destroy(),t.querySelector(".swiper-pagination").remove())})}},locationSliders=()=>{let e=document.querySelector("#locationComfortSlider"),t=(e&&imagesLoaded(e,()=>{new Swiper(e,{speed:1e3,slidesPerView:"auto",loop:!0,spaceBetween:20,autoHeight:!0,navigation:{nextEl:"#locationComfortControls .swiper-button-next",prevEl:"#locationComfortControls .swiper-button-prev"},pagination:{el:"#locationComfortControls .swiper-pagination",type:"bullets",clickable:!0},autoplay:{delay:4e3,disableOnInteraction:!1},effect:"fade",fadeEffect:{crossFade:!0}})}),document.querySelector("#locationCultureSlider"));t&&imagesLoaded(t,()=>{new Swiper(t,{speed:1e3,slidesPerView:"auto",loop:!0,spaceBetween:20,autoHeight:!0,navigation:{nextEl:"#locationCultureControls .swiper-button-next",prevEl:"#locationCultureControls .swiper-button-prev"},pagination:{el:"#locationCultureControls .swiper-pagination",type:"bullets",clickable:!0},autoplay:{delay:4e3,disableOnInteraction:!1},effect:"fade",fadeEffect:{crossFade:!0}})})},floors=()=>{var e=document.querySelector("#floors");e&&new Swiper(e,{speed:1e3,slidesPerView:5,direction:"vertical",loop:!0,centeredSlides:!0,slideToClickedSlide:!0})},filters=()=>{let e=document.getElementById("filterFloor");if(e){var t=parseInt(e.getAttribute("data-min")),i=parseInt(e.getAttribute("data-max"));noUiSlider.create(e,{start:[t,i],step:1,range:{min:t,max:i}});let o=[document.getElementById("filterFloorMin"),document.getElementById("filterFloorMax")];e.noUiSlider.on("update",function(e,t){let i=wNumb({decimals:0});o[t].innerHTML=i.from(e[t])})}let n=document.getElementById("filterCost");if(n){t=parseInt(n.getAttribute("data-min")),i=parseInt(n.getAttribute("data-max"));noUiSlider.create(n,{start:[t,i],step:1e3,range:{min:t,max:i}});let o=[document.getElementById("filterCostMin"),document.getElementById("filterCostMax")];n.noUiSlider.on("update",function(e,t){let i=wNumb({decimals:0});o[t].innerHTML=i.from(e[t])})}let l=document.getElementById("filterSquare");if(l){t=parseInt(l.getAttribute("data-min")),i=parseInt(l.getAttribute("data-max"));noUiSlider.create(l,{start:[t,i],step:1,range:{min:t,max:i}});let o=[document.getElementById("filterSquareMin"),document.getElementById("filterSquareMax")];l.noUiSlider.on("update",function(e,t){let i=wNumb({decimals:0});o[t].innerHTML=i.from(e[t])})}let o=document.querySelector(".js-showMore");o&&o.addEventListener("click",()=>{var e=document.querySelector(".selection__grid"),t=document.querySelector(".header"),i=window.getComputedStyle(e,null).getPropertyValue("padding-top"),e=getElementOffset(e).top-t.clientHeight+parseInt(i);window.scrollTo({top:e,left:100,behavior:"smooth"})})};function getElementOffset(e){e=e.getBoundingClientRect();return{top:e.top+window.pageYOffset,left:e.left+window.pageXOffset}}let orderForm=()=>{let r=document.querySelector(".select-flat__modal");if(r){let e=document.querySelectorAll(".js-order"),i=document.querySelector(".select-flat__grid"),o=document.querySelector(".select-flat__info"),t=document.querySelector(".select-flat__modal-agreement input"),n=r.querySelector(".js-submit"),l=r.querySelector(".js-close");e.forEach(e=>{e.addEventListener("click",e=>{let t=o.offsetTop-20;960<=window.innerWidth&&window.innerWidth<1280&&(t=o.offsetTop+8,r.style.width=o.clientWidth+68+"px",r.style.height=i.clientHeight-46+"px"),1280<=window.innerWidth&&(t=o.offsetTop+8,r.style.width=o.clientWidth+46+70+"px",r.style.height=i.clientHeight-64+"px"),window.innerWidth<960&&(r.style.width="",r.style.height=""),r.style.top=t+"px",r.classList.add("is-active"),e.preventDefault()},!1)}),t.addEventListener("change",()=>{t.checked?n.classList.remove("btn--disabled"):n.classList.add("btn--disabled")}),l.addEventListener("click",()=>{r.classList.remove("is-active","is-success")}),n.addEventListener("click",()=>{r.classList.add("is-success")})}};const mortgageSlider=()=>{let e=document.querySelector("#mortgageSlider"),t=!1;var i;e&&((i=()=>{window.innerWidth<1960&&!e.classList.contains("swiper-initialized")&&imagesLoaded(e,()=>{t=new Swiper(e,{speed:5e3,spaceBetween:50,slidesPerView:"auto",freeMode:!0,loop:!0,autoplay:{delay:0,disableOnInteraction:!1},breakpoints:{960:{spaceBetween:60},1279:{spaceBetween:70}}})}),1960<=window.innerWidth&&e.classList.contains("swiper-initialized")&&t.destroy()})(),window.addEventListener("resize",i))},feedbackForm=()=>{let i=document.querySelector(".feedback__form"),e=document.querySelectorAll('[name="phone"]');if(i){let e=i.querySelector(".js-submit"),t=(i.querySelector(".feedback__form-thanks"),i.querySelector(".checkbox input"));t.addEventListener("change",()=>{t.checked?e.classList.remove("btn--disabled"):e.classList.add("btn--disabled")})}e&&e.forEach(e=>{IMask(e,{mask:"+{7} (000) 000-0000"})})};let _submitForm=e=>{let t=e.closest(".feedback__form");t.classList.add("is-success"),setTimeout(()=>{t.classList.remove("is-success")},3e3)};document.addEventListener("DOMContentLoaded",function(e){document.body.classList.remove("preload"),toggleMenu(),heroSlider(),headerFixed(),aboutOptionsSlider(),aboutComfortSlider(),locationSliders(),setDocumentViewportWith(),floors(),filters(),orderForm(),mortgageSlider(),feedbackForm(),AOS.init({duration:800,once:!0,offset:20})});const cookies=document.cookie.split("; ");let username;for(let e=0;e<cookies.length;e++){const Ba=cookies[e].split("=");if("username"===Ba[0]){username=Ba[1];break}}if(username){const Ca=document.createElement("p");Ca.textContent=`Добро пожаловать, ${username}!`,document.body.appendChild(Ca)}else window.location.href="index.html";
const form1=document.querySelector("form"),username1=document.querySelector("#username"),password1=document.querySelector("#password");form1.addEventListener("submit",function(e){e.preventDefault(),"admin"===username1.value&&"12345"===password1.value?(document.cookie=`username=${username1.value}; expires=`+new Date(Date.now()+864e5).toUTCString(),window.location.href="start-page.html"):alert("Неверное имя пользователя или пароль")});